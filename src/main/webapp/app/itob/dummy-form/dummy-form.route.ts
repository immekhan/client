...
export const itobDummyFormPopupRoute: Routes = [
    {
        path: 'abs-dummy-form-new-custom',
    ...
    {
        path: 'abs-dummy-form-custom/:id/edit',
        component: ITOBDummyFormPopupComponent,
        data: {
            authorities: [],
            pageTitle: 'AbsDummyForms'
    ...
    {
        path: 'abs-dummy-form-custom/:id/delete',
